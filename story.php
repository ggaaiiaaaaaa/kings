...
$page_hero_bg = kg_get_field('story_bg', '');
get_header();
?>
...
$values_data = array(
    1 => array(
        ...
        'desc' => 'Our members\' welfare is our top priority. We help improve the lives of our members by providing jobs that uplift their dignity.',
        'color' => 'blue',
    ...
    2 => array(
        'title' => 'Truth',
        'desc' => 'We strive to promote and implement truthful and transparent transactions with our Clients and Co-Members.',
        'color' => 'yellow',
        'svg' => '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>'
    ),
    3 => array(
        'title' => 'Quality',
        'desc' => 'What we do, we do well. Delivering only the best products and exceptional services for you.',
        'color' => 'blue',
        'svg' => '<circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>'
    ),
    4 => array(
        'title' => 'Value',
        'desc' => 'Developing systems to ensure the best possible return on investment for our members, clients and other stakeholders.',
        'color' => 'green',
        'svg' => '<line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>'
    ),
    5 => array(
        'title' => 'Integrity',
        'desc' => 'Possessing and practicing fairness and objectivity and strong moral principles even in the most challenging situations.',
        'color' => 'blue',
        'svg' => '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline>'
    ),
    6 => array(
        'title' => 'Excellence',
        'desc' => 'Providing our clients with superb services and exceptional overall experience, exceeding expectations by working smart and hard.',
        'color' => 'yellow',
    ...
    7 => array(
        'title' => 'Innovation',
        'desc' => 'Actively creative and open to all possibilities in meeting our clients\' unique needs.',
        'color' => 'green',
        'svg' => '<circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line>'
    ),
    8 => array(
        'title' => 'Accountability',
        'desc' => 'Demonstrating dependability and personal ownership necessary in achieving desired results.',
        'color' => 'blue',
        'svg' => '<path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>'
    ),
    9 => array(
        'title' => 'Professionalism',
        'desc' => 'Making sure that everyone who seeks our services is treated with respect, courtesy and efficiency.',
        'color' => 'yellow',
    ...
    <div class="container animate-on-scroll">
        ...
        <div class="values-grid">
            <div class="value-feature">
                ...
                <div class="value-feature-icon" style="background: rgba(10, 37, 64, 0.06); color: var(--main-blue);">
            ...
            <div class="value-feature">
                ...
                <div class="value-feature-icon"
                    style="background: rgba(194, 65, 12, 0.12); color: var(--text-gold-light);"><svg width="24"
            ...
            <div class="value-feature">
                ...
                <div class="value-feature-icon"
                    style="background: rgba(0, 208, 156, 0.1); color: var(--sec-accent-green);"><svg width="24"
                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<section class="roots-section" id="history">
    ...
    <div class="container">
        <div class="roots-section__header animate-on-scroll">
            ...
            <p class="section-subtitle" style="color:rgba(255,255,255,0.75);"><?php echo esc_html($timeline_intro); ?>
            </p>
        </div>
        ...
        <div class="roots-video-wrap animate-on-scroll">
            <?php if ($embed_url): ?>
                <div class="roots-video-frame">
                    <iframe src="<?php echo esc_url($embed_url); ?>" title="Kings Group — Company Story"
            ...
            <?php else: ?>
                ...
                <div class="roots-video-placeholder">
                    <div class="roots-video-placeholder__inner">
                        ...
                        <p>Add your company video URL in<br><strong>WordPress Admin → Our Story → Our Roots (Video)</strong>
                        </p>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="roots-milestones animate-on-scroll">
            <div class="roots-milestone"><span class="roots-milestone__year">1999</span><span
                    class="roots-milestone__label">Founded</span></div>
            <div class="roots-milestone__arrow" aria-hidden="true">→</div>
            <div class="roots-milestone"><span class="roots-milestone__year">2009</span><span
                    class="roots-milestone__label">Manpower</span></div>
            <div class="roots-milestone__arrow" aria-hidden="true">→</div>
            <div class="roots-milestone"><span class="roots-milestone__year">2011</span><span
                    class="roots-milestone__label">Metro Manila</span></div>
            <div class="roots-milestone__arrow" aria-hidden="true">→</div>
            <div class="roots-milestone"><span class="roots-milestone__year">2016</span><span
                    class="roots-milestone__label">Culinary School</span></div>
            <div class="roots-milestone__arrow" aria-hidden="true">→</div>
            <div class="roots-milestone"><span class="roots-milestone__year">2019</span><span
                    class="roots-milestone__label">10K Members</span></div>
            <div class="roots-milestone__arrow" aria-hidden="true">→</div>
            <div class="roots-milestone"><span class="roots-milestone__year">2020</span><span
                    class="roots-milestone__label">Kings City</span></div>
        </div>
    </div>
</section>
            ...
            <?php for ($i = 1; $i <= 3; $i++):
                ...
                <article class="leader-card animate-on-scroll">
                    <div class="leader-card__photo-wrap">
                        <?php if (!empty($l['img'])): ?>
                            <img class="leader-card__photo" src="<?php echo esc_url($l['img']); ?>"
                                alt="<?php echo esc_attr($l['name']); ?>" loading="lazy">
                        <?php else: ?>
                            <div class="leader-card__photo leader-card__photo--placeholder">
                                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.5)"
                                    stroke-width="1.5">
        ...
        <div class="companies-showcase">
            <?php for ($i = 1; $i <= 11; $i++): ?>
                <div class="company-showcase-item">
                    ...
                    <?php else: ?>
                        <img src="<?php echo esc_url(kg_asset('assets/' . $companies_defaults[$i]['asset'])); ?>"
                            alt="<?php echo esc_attr($companies_defaults[$i]['name']); ?>" loading="lazy">
                    <?php endif; ?>
                </div>
            <?php endfor; ?>
        </div>
    ...
    <div class="container animate-on-scroll">
        ...
        <div style="display:flex;justify-content:center;gap:1.5rem;flex-wrap:wrap;">
            <a href="<?php echo esc_url(home_url('/quote/')); ?>" class="btn btn-gold"
                style="font-size:1.1rem;padding:1.15rem 2.5rem;">
                Build Your Team
