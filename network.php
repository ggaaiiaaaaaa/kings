            ...
            <div class="nw-stats-grid">
                ...
                ?>
                    <div class="nw-stat-item">
                        <span class="nw-stat-num stats-number" data-value="<?php echo esc_attr(str_replace(',', '', $stat_num)); ?>"><?php echo esc_html($stat_num); ?></span>
                        <span class="nw-stat-label"><?php echo esc_html($stat_label); ?></span>
                    </div>
                    <?php if ($i < 4): ?><div class="nw-stat-divider"></div><?php endif; ?>
                <?php 
                    endif;
                endfor; 
                ?>
            ...
            <div class="nw-cards-grid">
                ...
                <div class="nw-card">
                    <div class="nw-card-image">
                        <img src="<?php echo kg_asset('img/jobs_professional.webp'); ?>" alt="Professional Services" loading="lazy">
                ...
                <div class="nw-card">
                    <div class="nw-card-image">
                        <img src="<?php echo kg_asset('img/jobs_business.webp'); ?>" alt="Business and Industry" loading="lazy">
                        <div class="nw-card-overlay">
                            <span class="nw-card-category">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5">
                ...
                <div class="nw-card">
                    <div class="nw-card-image">
                        <img src="<?php echo kg_asset('img/jobs_food_beverage.webp'); ?>" alt="Food and Beverage" loading="lazy">
                        <div class="nw-card-overlay">
                            <span class="nw-card-category">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5">
                ...
                <div class="nw-card">
                    <div class="nw-card-image">
                        <img src="<?php echo kg_asset('img/jobs_sales_services.webp'); ?>" alt="Sales and Services" loading="lazy">
                        <div class="nw-card-overlay">
                            <span class="nw-card-category">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5">
                ...
                <div class="nw-card nw-card--wide">
                    <div class="nw-card-image">
                        <img src="<?php echo kg_asset('img/jobs_skilled_construction.webp'); ?>" alt="Skilled and Construction" loading="lazy">
                        <div class="nw-card-overlay">
                            <span class="nw-card-category">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5">
