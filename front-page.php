...
?>
    ...
    <section class="hero">
        ...
        $bg_image_1 = kg_get_field('hero_img_1', '');
        ?>
        <?php
        // Hero slider: all 3 slides now read from ACF
        $bg_image_2 = kg_get_field('hero_img_2', '');
        $bg_image_3 = kg_get_field('hero_img_3', '');
        ?>
        <div class="hero-bg-media" id="hero-slider">
            <?php echo kg_img($bg_image_1, 'Smiling Filipino professionals in a modern workspace', 'hero-slide active'); ?>
            <?php echo kg_img($bg_image_2, 'Team collaborating in modern office', 'hero-slide'); ?>
            <?php echo kg_img($bg_image_3, 'Colleagues discussing ideas enthusiastically', 'hero-slide'); ?>
        </div>
    ...
    <section class="trust-bar animate-on-scroll">
        <div class="trust-bar-label"><?php echo esc_html(kg_get_field('trust_label', 'Trusted by leading organizations worldwide')); ?></div>
    ...
    <section class="section section-bg-light">
        <div class="container animate-on-scroll">
            ...
            ?>
            <h2 class="section-title" style="color: var(--main-blue); margin-bottom: 0.5rem;"><?php echo esc_html($intro_title); ?></h2>
        ...
        <div class="container" style="display: flex; flex-direction: column; gap: 5rem; padding-top: 0.5rem;">
            ...
            <div class="staffing-split animate-on-scroll"
                ...
                <div class="staffing-content" style="flex: 1; min-width: 300px;">
                    <h2
                        style="font-size: 2rem; font-family: var(--font-header); color: var(--main-blue); margin-bottom: 0.75rem; line-height: 1.2;">
                        <?php echo wp_kses_post($app_headline); ?></h2>
                    <p style="font-size: 1.05rem; color: var(--text-dark); margin-bottom: 0.5rem; font-weight: 500;">
                        <?php echo esc_html($app_subheadline); ?></p>
                    <p style="color: var(--text-muted); margin-bottom: 1.5rem; line-height: 1.5; font-size: 0.95rem;">
                        <?php echo esc_html($app_desc); ?></p>
            ...
            <div class="affiliates-showcase-container">
                ...
                <div class="affiliate-showcase animate-on-scroll">
                    <div class="affiliate-showcase-image">
                        <?php echo kg_img('', 'The Kings City'); ?>
                    </div>
                    <div class="affiliate-showcase-content">
                        ...
                        <p>Our premier coworking and flex-office brand. We provide modern, inspiring workspaces designed
                            ...
                            business district.</p>
                        <a href="https://kingscity.netlify.app/" class="btn btn-primary" style="margin-top: 1rem;" target="_blank" rel="noopener">
                            Discover Kings City
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M5 12h14M12 5l7 7-7 7" />
                            </svg>
                ...
                <div class="affiliate-showcase reverse animate-on-scroll">
                    <div class="affiliate-showcase-image">
                        <?php echo kg_img('', 'The Social Manila'); ?>
                    </div>
                    <div class="affiliate-showcase-content">
                        ...
                        <p>The premier events, lifestyle, and community engagement hub. We host corporate functions,
                            ...
                            culture.</p>
                        <a href="https://the-social-manila-lifestyle-test-site.netlify.app/" class="btn btn-outline" style="margin-top: 1rem;" target="_blank" rel="noopener">
                            Explore The Social
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M5 12h14M12 5l7 7-7 7" />
                            </svg>
                ...
                <div class="affiliate-showcase animate-on-scroll">
                    <div class="affiliate-showcase-image">
                        <?php echo kg_img('', 'The Home Culinary School'); ?>
                    </div>
                    <div class="affiliate-showcase-content">
                        ...
                        <p>Professional culinary training and certification programs. Equipping the next generation of
                            ...
                            standards.</p>
                        <a href="https://unique-souffle-78e15a.netlify.app/" class="btn btn-primary" style="margin-top: 1rem;" target="_blank" rel="noopener">
                            Start Cooking
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M5 12h14M12 5l7 7-7 7" />
                            </svg>
