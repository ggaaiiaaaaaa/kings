...
$home_fields[] = array('key' => 'field_home_testi_title', 'label' => 'Section Title', 'name' => 'testi_title', 'type' => 'text', 'placeholder' => 'What Our Partners Say');
$home_fields[] = array('key' => 'field_home_testi_sub', 'label' => 'Section Subtitle', 'name' => 'testi_subtitle', 'type' => 'textarea', 'rows' => 2);

// Manual Repeaters for Testimonials (Max 4)
for ($i = 1; $i <= 4; $i++) {
    $home_fields[] = array('key' => 'field_home_t'.$i.'_quote', 'label' => 'Testimonial '.$i.' Quote', 'name' => 'testi_'.$i.'_quote', 'type' => 'textarea');
    $home_fields[] = array('key' => 'field_home_t'.$i.'_name', 'label' => 'Author '.$i.' Name', 'name' => 'testi_'.$i.'_name', 'type' => 'text', 'wrapper' => array('width' => '33'));
    $home_fields[] = array('key' => 'field_home_t'.$i.'_role', 'label' => 'Author '.$i.' Role', 'name' => 'testi_'.$i.'_role', 'type' => 'text', 'wrapper' => array('width' => '33'));
    $home_fields[] = array('key' => 'field_home_t'.$i.'_img', 'label' => 'Author '.$i.' Image', 'name' => 'testi_'.$i.'_img', 'type' => 'image', 'return_format' => 'url', 'wrapper' => array('width' => '33'));
}
...
// ==========================================
// 11. JOBS CUSTOM POST TYPE FIELDS
// ==========================================
acf_add_local_field_group(array(
    'key' => 'group_jobs_cpt',
    'title' => 'Job Role Settings',
    'fields' => array(
        array('key' => 'field_job_base_price', 'label' => 'Base Monthly Price (USD)', 'name' => 'base_price', 'type' => 'number', 'instructions' => 'The base monthly cost for this role at Junior level. Mid-Level = ×1.4, Senior = ×1.8.', 'placeholder' => '2000', 'prepend' => '$', 'wrapper' => array('width' => '50')),
        array('key' => 'field_job_include_team_builder', 'label' => 'Show in Team Builder?', 'name' => 'include_in_team_builder', 'type' => 'true_false', 'instructions' => 'Enable to show this job in the Quote page calculator.', 'default_value' => 1, 'ui' => 1, 'wrapper' => array('width' => '50')),
    ),
    'location' => array( array( array( 'param' => 'post_type', 'operator' => '==', 'value' => 'jobs' ) ) ),
    'position' => 'normal',
    'style' => 'default',
));
